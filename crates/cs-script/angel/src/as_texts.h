...
#define TEXT_BASE_DOESNT_HAVE_DEF_CONSTR                                                                               \
...
#define TXT_d_GC_CANNOT_FREE_OBJ_OF_TYPE_s_REF_COUNT_d                                                                 \
    "Object {%d}. GC cannot destroy an object of type '%s' as it can't see all references. Current ref count is %d."
...
#define TXT_LIST_FACTORY_EXPECTS_1_REF_PARAM                                                                           \
    "List factory expects only one reference parameter. The pointer to the initialization buffer will be passed in "   \
    "this parameter"
...
#define TXT_ENGINE_REF_COUNT_ERROR_DURING_SHUTDOWN                                                                     \
    "Uh oh! The engine's reference count is increasing while it is being destroyed. Make sure references needed for "  \
    "clean-up are immediately released"
