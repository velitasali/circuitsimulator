...
enum asEObjTypeFlags {
    ...
    asOBJ_APP_CLASS_CDK
    = ( asOBJ_APP_CLASS + asOBJ_APP_CLASS_CONSTRUCTOR + asOBJ_APP_CLASS_DESTRUCTOR + asOBJ_APP_CLASS_COPY_CONSTRUCTOR ),
    asOBJ_APP_CLASS_CAK
    = ( asOBJ_APP_CLASS + asOBJ_APP_CLASS_CONSTRUCTOR + asOBJ_APP_CLASS_ASSIGNMENT + asOBJ_APP_CLASS_COPY_CONSTRUCTOR ),
    ...
    asOBJ_APP_CLASS_DAK
    = ( asOBJ_APP_CLASS + asOBJ_APP_CLASS_DESTRUCTOR + asOBJ_APP_CLASS_ASSIGNMENT + asOBJ_APP_CLASS_COPY_CONSTRUCTOR ),
...
public:
    ...
    virtual void GetGCStatistics( asUINT* currentSize, asUINT* totalDestroyed = 0, asUINT* totalDetected = 0,
                                  asUINT* newObjects = 0, asUINT* totalNewDestroyed = 0 ) const
        = 0;
...
public:
    ...
    virtual int GetProperty( asUINT index, const char** name, int* typeId = 0, bool* isPrivate = 0,
                             ...
                             int* compositeOffset = 0, bool* isCompositeIndirect = 0 ) const
        = 0;
...
#define asBCINFO_DUMMY( b )                                                                                            \
    { asBC_MAXBYTECODE, asBCTYPE_INFO, 0, "BC_" #b }
