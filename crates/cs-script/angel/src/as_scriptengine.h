...
public:
    ...
    int RegisterMethodToObjectType( asCObjectType* objectType, const char* declaration, const asSFuncPtr& funcPointer,
                                    asDWORD callConv, void* auxiliary = 0, int compositeOffset = 0,
                                    bool isCompositeIndirect = false );
    ...
    asCScriptFunction* GenerateTemplateFactoryStub( asCObjectType* templateType, asCObjectType* templateInstanceType,
                                                    int origFactoryId );
    bool GenerateNewTemplateFunction( asCObjectType* templateType, asCObjectType* templateInstanceType,
                                      asCScriptFunction* templateFunc, asCScriptFunction** newFunc );
    asCFuncdefType* GenerateNewTemplateFuncdef( asCObjectType* templateType, asCObjectType* templateInstanceType,
